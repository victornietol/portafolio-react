    ...
    return (
        <>
            ...
            <div className="mt-5 mb-4">
                <h1 className="display-4 text-center">Videojuegos con Unity</h1>
            </div>
            ...
            <section className="card card-body mt-2">
                <div className="px-md-5 text-center">
                    <h3 className="pb-3 pt-3" style={{textAlign: "start"}}>Recorrido virtual</h3>
                    <p style={{textAlign: "justify"}}>
            ...
            <section className="card card-body mt-2">
                <div className="px-md-5 text-center">
                    <h3 className="pb-3 pt-3" style={{textAlign: "start"}}>RPG</h3>
                    <p style={{textAlign: "justify"}}>
            ...
            <section className="card card-body mt-2">
                <div className="px-md-5 text-center">
                    <h3 className="pb-3 pt-3" style={{textAlign: "start"}}>Pseudo Flappy Bird</h3>
                    <p style={{textAlign: "justify"}}>
