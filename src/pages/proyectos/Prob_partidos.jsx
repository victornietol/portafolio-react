            ...
            <div className="mt-5 mb-4">
                <h1 className="display-4 text-center">
                    <span className="palabra">
                        <span className="letra-hover-efecto">P</span><span className="letra-hover-efecto">r</span><span className="letra-hover-efecto">o</span><span className="letra-hover-efecto">b</span><span className="letra-hover-efecto">a</span><span className="letra-hover-efecto">b</span><span className="letra-hover-efecto">i</span><span className="letra-hover-efecto">l</span><span className="letra-hover-efecto">i</span><span className="letra-hover-efecto">d</span><span className="letra-hover-efecto">a</span><span className="letra-hover-efecto">d</span><span className="letra-hover-efecto">e</span><span className="letra-hover-efecto">s</span>{" "}
                    </span>
                    <span>
                        <span className="letra-hover-efecto">d</span><span className="letra-hover-efecto">e</span>{" "}
                    </span>
                    <span className="palabra">
                        <span className="letra-hover-efecto">p</span><span className="letra-hover-efecto">a</span><span className="letra-hover-efecto">r</span><span className="letra-hover-efecto">t</span><span className="letra-hover-efecto">i</span><span className="letra-hover-efecto">d</span><span className="letra-hover-efecto">o</span><span className="letra-hover-efecto">s</span>
                    </span>
                </h1>
            </div>
