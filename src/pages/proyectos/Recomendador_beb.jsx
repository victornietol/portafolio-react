    ...
    return (
        <>
            ...
            <div className="mt-5 mb-4">
                <h1 className="display-4 text-center">Recomandador de bebidas sencillo</h1>
            </div>
            ...
            <section className="card card-body mt-3">
                <div className="px-md-5 text-center">
                    ...
                    <div className="container">
                        <div className="row">
                            <section className="card card-body col-md-12 col-lg-6 d-flex flex-column align-items-center justify-content-center mt-1 mb-3">
