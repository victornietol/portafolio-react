...
function Bases_datos_sql() {
    ...
    return (
        <>
            ...
            <div className="mt-5 mb-4">
                <h1 className="display-4 text-center">
                    <span className="palabra">
                        <span className="letra-hover-efecto">B</span><span className="letra-hover-efecto">a</span><span className="letra-hover-efecto">s</span><span className="letra-hover-efecto">e</span><span className="letra-hover-efecto">s</span>{" "}
                    </span>
                    <span>
                        <span className="letra-hover-efecto">d</span><span className="letra-hover-efecto">e</span>{" "}
                    </span>
                    <span className="palabra">
                        <span className="letra-hover-efecto">d</span><span className="letra-hover-efecto">a</span><span className="letra-hover-efecto">t</span><span className="letra-hover-efecto">o</span><span className="letra-hover-efecto">s</span>{" "}
                    </span>
                    <span className="palabra">
                        <span className="letra-hover-efecto">S</span><span className="letra-hover-efecto">Q</span><span className="letra-hover-efecto">L</span>
                    </span>
                </h1>
            </div>
            ...
            <section id="bd_centrales" className="card card-body mt-3 card-borde">
                <div className="px-md-5">
                    <h3 className="pb-4 pt-4 texto-subt-efecto" style={{textAlign: "start"}}>1. Base de datos: Centrales électricas</h3>
                    <p>
                    ...
                    <h4 className="texto-subt-efecto" style={{textAlign: "start"}}>Entidades</h4>
                    <ul>
                        <li>
                            <p>
                    ...
                    <div className="mt-4" style={{textAlign: "start"}}>
                        <h4 className="texto-subt-efecto">Scripts</h4>
                        <div>
                            <ul>
                                <li>
            ...
            <section id="bd_universidad" className="card card-body mt-3 card-borde">
                <div className="px-md-5">
                    <h3 className="pb-4 pt-4 texto-subt-efecto" style={{textAlign: "start"}}>2. Base de datos: Gestión Académica de Universidad</h3>
                    <p>
                    ...
                    <div className="mt-4">
                        <h4 className="texto-subt-efecto" style={{textAlign: "start"}}>Triggers</h4>
                        <p>
                    ...
                    <div className="mt-4">
                        <h4 className="texto-subt-efecto" style={{textAlign: "start"}}>Procedimientos almacenados</h4>
                        <p>
                    ...
                    <div className="mt-4">
                        <h4 className="texto-subt-efecto" style={{textAlign: "start"}}>Vistas</h4>
                        <p>
            ...
            <section id="bd_cine" className="card card-body mt-3 card-borde">
                <div className="px-md-5">
                    <h3 className="pb-4 pt-4 texto-subt-efecto" style={{textAlign: "start"}}>3. Base de datos: Cine</h3>
                    <p>
