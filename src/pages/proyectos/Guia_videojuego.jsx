            ...
            <div className="mt-5 mb-4">
                <h1 className="display-4 text-center">
                    ...
                    <span className="palabra">
                        <span className="letra-hover-efecto">G</span><span className="letra-hover-efecto">u</span><span className="letra-hover-efecto">í</span><span className="letra-hover-efecto">a</span>{" "}
                    </span>
                    <span>
                        <span className="letra-hover-efecto">d</span><span className="letra-hover-efecto">e</span>{" "}
                    </span>
                    <span className="palabra">
                        <span className="letra-hover-efecto">V</span><span className="letra-hover-efecto">i</span><span className="letra-hover-efecto">d</span><span className="letra-hover-efecto">e</span><span className="letra-hover-efecto">o</span><span className="letra-hover-efecto">j</span><span className="letra-hover-efecto">u</span><span className="letra-hover-efecto">e</span><span className="letra-hover-efecto">g</span><span className="letra-hover-efecto">o</span>
                    </span>
                </h1>
            </div>
