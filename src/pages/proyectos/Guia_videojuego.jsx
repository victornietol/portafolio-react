            ...
            <section className="card card-body mt-3">
                <div className="px-md-5 text-center">
                    ...
                    <div className="text-center">
                        <img src="/src/assets/proyectos/guia_videojuego/1.png" title="Descripción AppBar y BottomNavigationBar" className="img-fluid mx-auto d-block" data-bs-toggle="modal" data-bs-target="#modalImagen" style={{cursor: "zoom-in"}} onClick={() => handleImageClick("/src/assets/proyectos/guia_videojuego/1.png")} alt="Img sistema 1" loading="lazy"></img>
                    </div>
                    ...
                    <div className="text-center">
                        <img src="/src/assets/proyectos/guia_videojuego/prev.jpeg" title="Vista Inicio" className="img-fluid mx-auto d-block border border-dark w-25 mt-4" data-bs-toggle="modal" data-bs-target="#modalImagen" style={{cursor: "zoom-in"}} onClick={() => handleImageClick("/src/assets/proyectos/guia_videojuego/prev.jpeg")} alt="Img sistema inicio" loading="lazy"></img>
                    </div>
                    ...
                    <div className="text-center">
                        <img src="/src/assets/proyectos/guia_videojuego/2.jpeg" title="Vista Combinaciones" className="img-fluid mx-auto d-block border border-dark w-25" data-bs-toggle="modal" data-bs-target="#modalImagen" style={{cursor: "zoom-in"}} onClick={() => handleImageClick("/src/assets/proyectos/guia_videojuego/2.jpeg")} alt="Img sistema 2" loading="lazy"></img>
                    </div>
                    <p className="mt-4" style={{textAlign: "justify"}}>
                    ...
                    <div className="container">
                        <div className="row">
                            <div className="col-md-6 col-lg-6">
                                <img src="/src/assets/proyectos/guia_videojuego/3.jpeg" title="Vista Personas 1" className="img-fluid mx-auto d-block border border-dark mt-2 w-50" data-bs-toggle="modal" data-bs-target="#modalImagen" style={{cursor: "zoom-in"}} onClick={() => handleImageClick("/src/assets/proyectos/guia_videojuego/3.jpeg")} alt="Img sistema 3" loading="lazy"></img>
                            </div>
                            <div className="col-md-6 col-lg-6">
                                <img src="/src/assets/proyectos/guia_videojuego/4.jpeg" title="Vista Personas 2" className="img-fluid mx-auto d-block border border-dark mt-2 w-50" data-bs-toggle="modal" data-bs-target="#modalImagen" style={{cursor: "zoom-in"}} onClick={() => handleImageClick("/src/assets/proyectos/guia_videojuego/4.jpeg")} alt="Img sistema 4" loading="lazy"></img>
                            </div>
                        </div>
                    </div>
                    <p className="mt-4" style={{textAlign: "justify"}}>
                    ...
                    <div className="container">
                        <div className="row">
                            <div className="col-md-6 col-lg-6">
                                <img src="/src/assets/proyectos/guia_videojuego/5.jpeg" title="Vista Wishlist 1" className="img-fluid mx-auto d-block border border-dark mt-2 w-50" data-bs-toggle="modal" data-bs-target="#modalImagen" style={{cursor: "zoom-in"}} onClick={() => handleImageClick("/src/assets/proyectos/guia_videojuego/5.jpeg")} alt="Img sistema 6" loading="lazy"></img>
                            </div>
                            <div className="col-md-6 col-lg-6">
                                <img src="/src/assets/proyectos/guia_videojuego/6.jpeg" title="Vista Wishlist 2" className="img-fluid mx-auto d-block border border-dark mt-2 w-50" data-bs-toggle="modal" data-bs-target="#modalImagen" style={{cursor: "zoom-in"}} onClick={() => handleImageClick("/src/assets/proyectos/guia_videojuego/6.jpeg")} alt="Img sistema 6" loading="lazy"></img>
                            </div>
                        </div>
                    </div>
                    <p className="mt-4" style={{textAlign: "justify"}}>
                    ...
                    <img src="/src/assets/proyectos/guia_videojuego/7.jpeg" title="Vista Calendario" className="img-fluid mx-auto d-block border border-dark w-25 mt-4" data-bs-toggle="modal" data-bs-target="#modalImagen" style={{cursor: "zoom-in"}} onClick={() => handleImageClick("/src/assets/proyectos/guia_videojuego/7.jpeg")} alt="Img sistema 7" loading="lazy"></img>
                    <p className="mt-4" style={{textAlign: "justify"}}>
                    ...
                    <img src="/src/assets/proyectos/guia_videojuego/8.jpeg" title="Vista Guías" className="img-fluid mx-auto d-block border border-dark w-25 mt-4" data-bs-toggle="modal" data-bs-target="#modalImagen" style={{cursor: "zoom-in"}} onClick={() => handleImageClick("/src/assets/proyectos/guia_videojuego/8.jpeg")} alt="Img sistema 8" loading="lazy"></img>
                    <p className="mt-4" style={{textAlign: "justify"}}>
                    ...
                    <div className="container">
                        <div className="row">
                            <div className="col-md-6 col-lg-6">
                                <img src="/src/assets/proyectos/guia_videojuego/9.jpeg" title="Vista Posibles finales 1" className="img-fluid mx-auto d-block border border-dark mt-2 w-50" data-bs-toggle="modal" data-bs-target="#modalImagen" style={{cursor: "zoom-in"}} onClick={() => handleImageClick("/src/assets/proyectos/guia_videojuego/9.jpeg")} alt="Img sistema 9" loading="lazy"></img>
                            </div>
                            <div className="col-md-6 col-lg-6">
                                <img src="/src/assets/proyectos/guia_videojuego/10.jpeg" title="Vista Posibles finales 2" className="img-fluid mx-auto d-block border border-dark mt-2 w-50" data-bs-toggle="modal" data-bs-target="#modalImagen" style={{cursor: "zoom-in"}} onClick={() => handleImageClick("/src/assets/proyectos/guia_videojuego/10.jpeg")} alt="Img sistema 10" loading="lazy"></img>
                            </div>
                        </div>
                    </div>
                    <p className="mt-4" style={{textAlign: "justify"}}>
                    ...
                    <div className="container">
                        <div className="row">
                            <div className="col-md-6 col-lg-6">
                                <img src="/src/assets/proyectos/guia_videojuego/11.jpeg" title="Vista Libros 1" className="img-fluid mx-auto d-block border border-dark mt-2 w-50" data-bs-toggle="modal" data-bs-target="#modalImagen" style={{cursor: "zoom-in"}} onClick={() => handleImageClick("/src/assets/proyectos/guia_videojuego/11.jpeg")} alt="Img sistema 11" loading="lazy"></img>
                            </div>
                            <div className="col-md-6 col-lg-6">
                                <img src="/src/assets/proyectos/guia_videojuego/12.jpeg" title="Vista Libros 2" className="img-fluid mx-auto d-block border border-dark mt-2 w-50" data-bs-toggle="modal" data-bs-target="#modalImagen" style={{cursor: "zoom-in"}} onClick={() => handleImageClick("/src/assets/proyectos/guia_videojuego/12.jpeg")} alt="Img sistema 12" loading="lazy"></img>
                            </div>
                        </div>
                    </div>
                    <p className="mt-4" style={{textAlign: "justify"}}>
                    ...
                    <img src="/src/assets/proyectos/guia_videojuego/13.jpeg" title="Vista RespuestasExamanes" className="img-fluid mx-auto d-block border border-dark w-25 mt-3" data-bs-toggle="modal" data-bs-target="#modalImagen" style={{cursor: "zoom-in"}} onClick={() => handleImageClick("/src/assets/proyectos/guia_videojuego/13.jpeg")} alt="Img sistema 13" loading="lazy"></img>
                    <p className="mt-4" style={{textAlign: "justify"}}>
                    ...
                    <div className="container">
                        <div className="row">
                            <div className="col-md-6 col-lg-6">
                                <img src="/src/assets/proyectos/guia_videojuego/14.jpeg" title="Vista Social Links 1" className="img-fluid mx-auto d-block border border-dark mt-2 w-50" data-bs-toggle="modal" data-bs-target="#modalImagen" style={{cursor: "zoom-in"}} onClick={() => handleImageClick("/src/assets/proyectos/guia_videojuego/14.jpeg")} alt="Img sistema 14" loading="lazy"></img>
                            </div>
                            <div className="col-md-6 col-lg-6">
                                <img src="/src/assets/proyectos/guia_videojuego/15.jpeg" title="Vista Social Links 2" className="img-fluid mx-auto d-block border border-dark mt-2 w-50" data-bs-toggle="modal" data-bs-target="#modalImagen" style={{cursor: "zoom-in"}} onClick={() => handleImageClick("/src/assets/proyectos/guia_videojuego/15.jpeg")} alt="Img sistema 15" loading="lazy"></img>
                            </div>
                        </div>
                    </div>
                    <p className="mt-4" style={{textAlign: "justify"}}>
                    ...
                    <img src="/src/assets/proyectos/guia_videojuego/16.jpeg" title="Vista Iniciar Sesión" className="img-fluid mx-auto d-block border border-dark w-25 mt-3" data-bs-toggle="modal" data-bs-target="#modalImagen" style={{cursor: "zoom-in"}} onClick={() => handleImageClick("/src/assets/proyectos/guia_videojuego/16.jpeg")} alt="Img sistema 16" loading="lazy"></img>
                    <p className="mt-4" style={{textAlign: "justify"}}>
                    ...
                    <div className="container">
                        <div className="row">
                            <div className="col-md-6 col-lg-6">
                                <img src="/src/assets/proyectos/guia_videojuego/17.jpeg" title="Vista Social Links 1" className="img-fluid mx-auto d-block border border-dark mt-2 w-50" data-bs-toggle="modal" data-bs-target="#modalImagen" style={{cursor: "zoom-in"}} onClick={() => handleImageClick("/src/assets/proyectos/guia_videojuego/17.jpeg")} alt="Img sistema 17" loading="lazy"></img>
                            </div>
                            <div className="col-md-6 col-lg-6">
                                <img src="/src/assets/proyectos/guia_videojuego/18.jpeg" title="Vista Social Links 2" className="img-fluid mx-auto d-block border border-dark mt-2 w-50" data-bs-toggle="modal" data-bs-target="#modalImagen" style={{cursor: "zoom-in"}} onClick={() => handleImageClick("/src/assets/proyectos/guia_videojuego/18.jpeg")} alt="Img sistema 18" loading="lazy"></img>
                            </div>
                        </div>
                    </div>
                </div>
