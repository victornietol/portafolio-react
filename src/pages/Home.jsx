...
function Home() {
    return (
        <>
            ...
            <section className="card card-body card-borde mt-5">
                <div>
                    <h1 className="display-3 text-center">
                        <span>
                            <span className="letra-hover-efecto">V</span><span className="letra-hover-efecto">i</span><span className="letra-hover-efecto">c</span><span className="letra-hover-efecto">t</span><span className="letra-hover-efecto">o</span><span className="letra-hover-efecto">r</span>{" "}
                        </span>
                        <span>
                            <span className="letra-hover-efecto">M</span><span className="letra-hover-efecto">a</span><span className="letra-hover-efecto">n</span><span className="letra-hover-efecto">u</span><span className="letra-hover-efecto">e</span><span className="letra-hover-efecto">l</span>{" "}
                        </span>
                        <span className="palabra">
                            <span className="letra-hover-efecto">N</span><span className="letra-hover-efecto">i</span><span className="letra-hover-efecto">e</span><span className="letra-hover-efecto">t</span><span className="letra-hover-efecto">o</span>{" "}
                        </span>
                        <span className="palabra">
            ...
            <section className="card card-body card-borde mt-3">
                <h2 className="text-center texto-subt-efecto pb-3">Tecnologías y Habilidades</h2>
                <div className="container">
                    <div className="row">
                        <section className="col-md-6 col-lg-4 card card-body m-2 d-flex flex-column align-items-center justify-content-center bg-light efecto-card-glow">
                            <div className="pt-2 pb-3">
                                <p className="texto-categoria-tec text-center texto-subt-efecto">Lenguajes de programación principales</p>
                        ...
                        <section className="col-md-6 col-lg-4 card card-body m-2 d-flex flex-column align-items-center justify-content-center bg-light efecto-card-glow">
                            <div className="pt-2">
                                <p className="texto-categoria-tec text-center texto-subt-efecto">Creación y administracón de bases de datos relacionales</p>
                        ...
                        <section className="col-md-6 col-lg-4 card card-body m-2 d-flex flex-column align-items-center justify-content-center bg-light efecto-card-glow">
                            <div className="pt-2">
                                <p className="texto-categoria-tec text-center texto-subt-efecto">Desarrollo móvil</p>
                        ...
                        <section className="col-md-6 col-lg-4 card card-body m-2 d-flex flex-column align-items-center justify-content-center bg-light efecto-card-glow">
                            <div className="pt-2">
                                <p className="texto-categoria-tec text-center texto-subt-efecto">Conocimientos básicos en otras tecnologías</p>
                        ...
                        <section className="col-md-6 col-lg-4 card card-body m-2 d-flex flex-column align-items-center justify-content-center bg-light efecto-card-glow">
                            <div className="pt-2">
                                <p className="texto-categoria-tec text-center texto-subt-efecto">Control de versiones</p>
                                <div className="text-center pt-3 pb-3">
                        ...
                        <section className="col-md-6 col-lg-4 card card-body m-2 d-flex flex-column align-items-center justify-content-center bg-light efecto-card-glow">
                            <div className="pt-2">
                                <p className="texto-categoria-tec text-center texto-subt-efecto">Desarrollo de videojuegos</p>
            ...
            <section className="card card-body card-borde mt-3">
                <h2 className="text-center texto-subt-efecto">Educación</h2>
